...
BOT_TOKEN = environ.get("BOT_TOKEN", "6699641330:AAHwjck1g2f2ZU0jlCPLoJPUkVFWM16s8Tg")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 99999))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/33472b8bd6fca69fe74d3.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001587861988')
auth_grp = environ.get('AUTH_GROUP', '-1001505526419')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001439221164')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001439221164')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'MoviesV3')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/DotexRequest')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/DotexHub')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ɴ33ᴠᴀʀᴘ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001587861988'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1001439221164')
